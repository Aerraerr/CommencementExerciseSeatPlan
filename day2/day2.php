...
<div style="display:flex; justify-content:center; margin-top:15px;">
    <a href="pages/seatplan.html" target="_blank"
        style="padding:10px 20px; background: lightblue; color:black; text-decoration:none; border-radius:8px; font-size:13px; font-weight:600; box-shadow:0 3px 8px rgba(0,0,0,0.15); transition: all 0.2s ease; display:inline-block; " onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 5px 15px rgba(0,0,0,0.25)'" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 3px 8px rgba(0,0,0,0.15)'"> View Official Seatplan
    </a>
</div>
